...
exports.TTS_SUPPORTED = exports.SPEECH_CODES = exports.LANG_FLAGS = exports.LANGUAGES = exports.ALL_LANGUAGES = void 0;
exports.getLanguage = getLanguage;
exports.getLanguageName = getLanguageName;
exports.getLanguageNativeName = getLanguageNativeName;
exports.getLanguageFlag = getLanguageFlag;
exports.getBcp47 = getBcp47;
exports.isRtl = isRtl;
...
exports.ALL_LANGUAGES = [...LANGUAGE_DATA].sort((a, b) => a.name.localeCompare(b.name));
...
exports.LANGUAGES = Object.fromEntries(LANGUAGE_DATA.map((l) => [l.code, l.name]));
exports.LANG_FLAGS = Object.fromEntries(LANGUAGE_DATA.map((l) => [l.code, l.flag ?? '🌐']));
exports.SPEECH_CODES = Object.fromEntries(LANGUAGE_DATA.map((l) => [l.code, l.bcp47 ?? l.code]));
// ── TTS Support Map ────────────────────────────────────────
...
function isTtsSupported(code) {
    return exports.TTS_SUPPORTED.has(code);
}
