                  ...
                  <View style={styles.dueTop}>
                    ...
                    <View style={{ alignItems: 'flex-end', gap: 4 }}>
                      ...
                      <View style={{ flexDirection: 'row', gap: Spacing.xs }}>
                        {isAdmin && (
                          <TouchableOpacity onPress={() => handleEditDue(due)} style={{ flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#2563EB', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6 }}>
                            <Ionicons name="create-outline" size={14} color="#FFFFFF" />
                            <Text style={{ fontSize: 12, color: '#FFFFFF', fontWeight: '700' }}>Edit</Text>
                          </TouchableOpacity>
                        )}
                ...
                <Card key={fine.id} style={styles.dueCard}>
                  <View style={styles.dueTop}>
                    ...
                    <View style={{ alignItems: 'flex-end', gap: 4 }}>
                      ...
                      <View style={{ flexDirection: 'row', gap: Spacing.xs }}>
                        {isAdmin && (
                          <TouchableOpacity onPress={() => handleEditFine(fine)} style={{ flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#2563EB', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6 }}>
                            <Ionicons name="create-outline" size={14} color="#FFFFFF" />
                            <Text style={{ fontSize: 12, color: '#FFFFFF', fontWeight: '700' }}>Edit</Text>
                          </TouchableOpacity>
                        )}
                      ...
                      <View style={{ flex: 1 }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                          ...
                          <View style={{ flexDirection: 'row', gap: Spacing.xs, marginLeft: Spacing.sm }}>
                            {isAdmin && (
                              <TouchableOpacity onPress={() => handleEditCampaign(camp)} style={{ flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#2563EB', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6 }}>
                                <Ionicons name="create-outline" size={14} color="#FFFFFF" />
                                <Text style={{ fontSize: 12, color: '#FFFFFF', fontWeight: '700' }}>Edit</Text>
                              </TouchableOpacity>
                            )}
