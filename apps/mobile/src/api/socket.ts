...
class SocketClient {
  ...
  setTranslationLanguage(meetingId: string, language: string, receiveVoice: boolean = true, platform: string = 'web'): void {
    this.socket?.emit('translation:set-language', { meetingId, language, receiveVoice, platform });
  }
