...
function getMetricsSnapshot() {
    ...
    return {
        ...
        business: {
            meetingsCreated: exports.metrics.meetingsCreated.value,
            meetingsActive: exports.metrics.meetingsActive.value,
            meetingsCompleted: exports.metrics.meetingsCompleted.value,
            ...
            translationMinutesUsed: exports.metrics.translationMinutesUsed.value,
        },
        organizations: {
...
exports.MetricsHelper = {
    ...
    trackMeeting(action) {
        exports.metrics[`meetings${action.charAt(0).toUpperCase() + action.slice(1)}`];
        if (action === 'created')
            exports.metrics.meetingsCreated.inc();
        if (action === 'active')
            exports.metrics.meetingsActive.inc();
        if (action === 'completed')
            exports.metrics.meetingsCompleted.inc();
    },
    ...
    trackTranslation(minutes) {
        exports.metrics.translationMinutesUsed.inc(minutes);
    },
