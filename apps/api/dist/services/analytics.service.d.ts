export type AnalyticsEvent = 'member.joined' | 'member.removed' | 'org.created' | 'org.subscription_upgraded' | 'org.subscription_downgraded' | 'wallet.funded' | 'wallet.deducted' | 'payment.completed' | 'payment.failed' | 'announcement.sent' | 'poll.created' | 'poll.voted' | 'document.uploaded' | 'event.created' | 'chat.message_sent' | 'auth.login' | 'auth.register' | 'auth.password_change';
