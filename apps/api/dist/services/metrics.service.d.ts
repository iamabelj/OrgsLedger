...
export declare const metrics: {
    ...
    meetingsCreated: Counter;
    meetingsActive: Counter;
    meetingsCompleted: Counter;
    walletOperations: Counter;
    walletDeductions: Counter;
    aiMinutesUsed: Counter;
    translationMinutesUsed: Counter;
    orgsCreated: Counter;
