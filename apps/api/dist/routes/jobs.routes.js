...
const bot_queue_1 = require("../queues/bot.queue");
...
router.get('/jobs/:jobId', middleware_1.authenticate, async (req, res) => {
    try {
        ...
        const queues = [
            { name: 'minutes', manager: (0, minutes_queue_1.getMinutesQueueManager)() },
            { name: 'processing', manager: processing_queue_1.processingQueueManager },
            { name: 'broadcast', manager: broadcast_queue_1.broadcastQueueManager },
            ...
            { name: 'bot', manager: (0, bot_queue_1.getBotQueueManager)() },
        ];
...
router.get('/jobs/queue/:queueName', middleware_1.authenticate, async (req, res) => {
    try {
        ...
        const queues = {
            minutes: (0, minutes_queue_1.getMinutesQueueManager)(),
            processing: processing_queue_1.processingQueueManager,
            broadcast: broadcast_queue_1.broadcastQueueManager,
            email: (0, email_queue_1.getEmailQueueManager)(),
            notification: (0, notification_queue_1.getNotificationQueueManager)(),
            bot: (0, bot_queue_1.getBotQueueManager)(),
        };
