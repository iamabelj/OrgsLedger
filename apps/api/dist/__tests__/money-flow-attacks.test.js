...
describe('Malicious Money Attack Simulations', () => {
    ...
    describe('ATTACK: Negative amount injection', () => {
        it('should prevent negative minute deduction (which would ADD balance)', async () => {
            ...
            const result = await (0, subscription_service_1.deductAiWallet)('org-1', -100, 'Negative injection');
        ...
        it('should prevent negative minute deduction on translation wallet', async () => {
            ...
            const result = await (0, subscription_service_1.deductTranslationWallet)('org-1', -50, 'Negative translation');
    ...
    describe('ATTACK: Zero amount operations', () => {
        it('should handle zero-minute deduction gracefully', async () => {
            ...
            const result = await (0, subscription_service_1.deductAiWallet)('org-1', 0, 'Zero deduction spam');
    ...
    describe('ATTACK: Currency manipulation', () => {
        ...
        it('getPlanPrice safely returns 0 for null/missing plan data', () => {
            ...
            expect((0, subscription_service_1.getPlanPrice)(brokenPlan, 'USD', 'monthly')).toBe(0);
            expect((0, subscription_service_1.getPlanPrice)(brokenPlan, 'NGN', 'annual')).toBe(0);
            expect((0, subscription_service_1.getPlanPrice)(brokenPlan, 'USD', 'annual')).toBe(0);
        });
            ...
            db_1.default.mockImplementation((_table) => {
                ...
                chain.insert.mockImplementation((data) => {
                    if (data?.amount_paid !== undefined)
                        writtenAmount.push(data.amount_paid);
                    return chain;
                });
    ...
    describe('ATTACK: Rapid-fire operations', () => {
        it('no rate limit on wallet top-up endpoint', async () => {
            ...
            const promises = [];
            for (let i = 0; i < 100; i++) {
                promises.push((0, subscription_service_1.topUpAiWallet)({
                    orgId: 'org-1',
                    minutes: 60,
                    cost: 10,
                    currency: 'USD',
            ...
            expect(db_1.default.transaction).toHaveBeenCalledTimes(100);
        });
    });
    ...
    describe('ATTACK: Cross-org wallet targeting', () => {
        it('deduction targets specific orgId (tenant scoped)', async () => {
            ...
            const result = await (0, subscription_service_1.deductAiWallet)('org-victim', 100, 'Cross-org theft');
    ...
    describe('ATTACK: Numeric boundary attacks', () => {
        ...
        it('should handle NaN minutes', async () => {
            ...
            const result = await (0, subscription_service_1.deductAiWallet)('org-1', 10, 'NaN balance exploit');
    ...
    describe('ATTACK: Concurrent deduction races', () => {
        it('SECURE: deductAiWallet uses FOR UPDATE lock', async () => {
            ...
            await (0, subscription_service_1.deductAiWallet)('org-1', 50, 'Concurrent deduction 1');
...
//# sourceMappingURL=money-flow-attacks.test.js.map