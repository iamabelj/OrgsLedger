...
jest.mock('jsonwebtoken', () => ({
    ...
    JsonWebTokenError: class JsonWebTokenError extends Error {
        constructor(msg) { super(msg); this.name = 'JsonWebTokenError'; }
    },
    TokenExpiredError: class TokenExpiredError extends Error {
        expiredAt;
        constructor(msg, expiredAt) { super(msg); this.name = 'TokenExpiredError'; this.expiredAt = expiredAt; }
    },
}));
const mockDbFirst = jest.fn();
const mockDbWhere = jest.fn();
const chain = {};
['where', 'first', 'select', 'insert', 'update'].forEach((m) => (chain[m] = jest.fn().mockReturnValue(chain)));
...
describe('Token Tampering & JWT Security', () => {
    ...
    describe('Expired tokens', () => {
        it('should reject expired access token', async () => {
            mockVerify.mockImplementation(() => {
                ...
                err.expiredAt = new Date('2025-01-01');
                throw err;
            });
    ...
    describe('Payload manipulation', () => {
        ...
        it('should use payload from JWT, not from request body/headers', async () => {
            ...
            req.body = { userId: 'attacker-injected-id', globalRole: 'super_admin' };
            const res = createRes();
            const next = jest.fn();
            await (0, auth_1.authenticate)(req, res, next);
    ...
    describe('Token state validation', () => {
        it('should always re-verify user exists on each request (no caching)', async () => {
            ...
            const next1 = jest.fn();
            await (0, auth_1.authenticate)(req1, res1, next1);
            ...
            const next2 = jest.fn();
            await (0, auth_1.authenticate)(req2, res2, next2);
...
//# sourceMappingURL=security-token-tampering.test.js.map