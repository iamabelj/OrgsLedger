...
class ApiClient {
  ...
  Future<Response> createMeeting(String orgId, Map<String, dynamic> data) =>
      dio.post('/meetings/$orgId', data: data);

  Future<Response> updateMeeting(
    String orgId,
    String meetingId,
    Map<String, dynamic> data,
  ) => dio.put('/meetings/$orgId/$meetingId', data: data);

  Future<Response> startMeeting(String orgId, String meetingId) =>
      dio.post('/meetings/$orgId/$meetingId/start');

  Future<Response> endMeeting(String orgId, String meetingId) =>
      dio.post('/meetings/$orgId/$meetingId/end');
  ...
  Future<Response> joinMeeting(
    ...
    '/meetings/$orgId/$meetingId/join',
    data: {'joinType': joinType},
  );

  Future<Response> leaveMeeting(String orgId, String meetingId) =>
      dio.post('/meetings/$orgId/$meetingId/leave');

  Future<Response> toggleAi(String orgId, String meetingId) =>
      dio.post('/meetings/$orgId/$meetingId/toggle-ai');

  Future<Response> getTranscripts(String orgId, String meetingId) =>
      dio.get('/meetings/$orgId/$meetingId/transcripts');

  Future<Response> getMinutes(String orgId, String meetingId) =>
      dio.get('/meetings/$orgId/$meetingId/minutes');

  Future<Response> generateMinutes(String orgId, String meetingId) =>
      dio.post('/meetings/$orgId/$meetingId/generate-minutes');

  Future<Response> getMeetingChat(String orgId, String meetingId) =>
      dio.get('/meetings/$orgId/$meetingId/chat');

  Future<Response> createVote(
    String orgId,
    String meetingId,
    Map<String, dynamic> data,
  ) => dio.post('/meetings/$orgId/$meetingId/votes', data: data);

  Future<Response> castVote(
    String orgId,
    String meetingId,
    String voteId,
    String option,
  ) => dio.post(
    '/meetings/$orgId/$meetingId/votes/$voteId/cast',
    data: {'option': option},
  );
