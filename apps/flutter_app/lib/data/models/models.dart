...
class Meeting {
  ...
  Meeting copyWith({bool? aiEnabled, String? status}) => Meeting(
    id: id,
  ...
  factory Meeting.fromJson(Map<String, dynamic> json) => Meeting(
    ...
    scheduledStart: json['scheduled_start'] ?? json['scheduledStart'],
    actualStart: json['actual_start'] ?? json['actualStart'],
    actualEnd: json['actual_end'] ?? json['actualEnd'],
    meetingType: json['meeting_type'] ?? json['meetingType'] ?? 'video',
    aiEnabled: json['ai_enabled'] ?? json['aiEnabled'] ?? false,
    translationEnabled:
        json['translation_enabled'] ?? json['translationEnabled'] ?? false,
    createdBy: json['created_by'] ?? json['createdBy'],
    attendance: json['attendance'] ?? [],
    agendaItems: json['agenda_items'] ?? json['agendaItems'] ?? [],
  );
}
